...
"groq",
    ...
    "Why do I only get motivated to clean when guests are coming over? 🧹",
        ...
        "BTS military service 🪖", "Kanye West rants 🎤", "Rihanna baby pics 👶", "Tom Cruise stunts 🎬", "Harry Styles dating 💘", "Adele Vegas residency 🎰", "Kardashian drama 💄", "Billie Eilish hair color 💇", "Chris Rock slap joke 👋", "Lady Gaga Joker 2 🃏", "Ariana Grande wedding 👰", "Johnny Depp comeback 🏴‍☠️", "Selena Gomez lupus 🩺", "Dua Lipa dance moves 💃", "Marvel movie leak 🦸",
