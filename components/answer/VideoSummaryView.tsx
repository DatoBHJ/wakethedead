...
const EditableArticleView: React.FC<EditableArticleViewProps> = ({ content, onTimestampClick, onEdit, isEditing }) => {
  ...
  const components: Components = {
    ...
    h2: ({ children }) => <h2 className="backdrop-blur-xl bg-card-foreground/[3%] dark:bg-card-foreground/5 rounded-xl p-3 px-6 text-xl font-handwriting font-semibold mt-6 mb-3 break-words">{renderWithClickableTimestamps(children)}</h2>,
