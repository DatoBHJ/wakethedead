                    ...
                    >
                        <div className="flex-shrink-0 w-5 h-5 flex items-center justify-center mr-3">
                            {clickedQuestions.has(question) ? (
                                ...
                                <IconPlus className="h-5 w-5 text-gray-400 group-hover:text-purple-500 dark:group-hover:text-purple-400 transition-colors duration-200" />
                            )}
                        </div>
                        <p className={`text-base flex-1 ${clickedQuestions.has(question) ? 'text-gray-500' : 'text-card-foreground dark:text-gray-400 group-hover:text-purple-700 dark:group-hover:text-purple-300'} transition-colors duration-200`}>
                            {question}
                        </p>
                        {clickedQuestions.has(question) && (
